...
import { listCategorias } from '@angular-app/features/products/domain/usecases/list-categorias.use-case'
import { listProductos } from '@angular-app/features/products/domain/usecases/list-productos.use-case'
import type { Categoria, Product } from '@angular-app/features/products/domain/entities/product.entity'
import type { CategoriaRepository, ProductRepository } from '@angular-app/features/products/domain/repositories/product.repository'
