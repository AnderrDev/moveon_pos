...
- **UX (rev. 2026-08-03):** tocar el producto lo agrega directo con su opción por defecto; la proteína se cambia desde el chip de la línea del carrito. Cambiarla recalcula el precio, recorta el descuento manual al precio nuevo, arrastra el canje del Club y fusiona la línea si ya había otra con esa proteína.
