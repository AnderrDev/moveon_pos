...
import { CashierBreakdownListComponent } from '@angular-app/features/reports/presentation/components/cashier-breakdown-list.component'
import { CashClosuresTableComponent } from '@angular-app/features/reports/presentation/components/cash-closures-table.component'
import { SalesTrendTablesComponent } from '@angular-app/features/reports/presentation/components/sales-trend-tables.component'
import { SaleDetailListComponent } from '@angular-app/shared/organisms/sale-detail-list.component'
import { ProductSalesSearchComponent } from '@angular-app/features/reports/presentation/components/product-sales-search.component'
...
import { buildDailyReportWorkbook, buildStockReportWorkbook } from '@angular-app/features/reports/presentation/services/report-export'
import {
  isoDate,
  resolvePreset,
  type Preset,
