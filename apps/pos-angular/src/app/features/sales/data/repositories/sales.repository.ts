...
const ITEM_COLS =
  'id, sale_id, producto_id, producto_nombre, producto_sku, quantity, unit_price, unit_cost, discount_amount, global_discount_amount, option_nombre, option_extra, tax_rate, tax_amount, total'
