            ...
            >
              ...
              @if (isExpanded(sale)) {
                ...
                >
                  <mo-sale-detail
                    [sale]="sale"
                    [canCorrectPayment]="canCorrectPaymentComputed()"
                    [cashSessionIsOpen]="cashSessionIsOpen()"
                    (correctPaymentRequested)="
                      openCorrectPayment(sale, $event.paymentId, $event.currentMetodo)
                    "
                  />
